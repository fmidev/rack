...
#        "format": 'x "%s"',
    ...
    for f in files:
        ...
        linetype = "lines"
        # linetype = rack.gnuplot.Style.LINES.value
        ...
        plot_style = rack.gnuplot.Literal(f"{linetype} lw 3 {linecolor}".strip())
    ...
    if args.gnuplot or args.gnuplot_script:    
        ...
        if not args.gnuplot_script:
            ...
            with open(args.gnuplot_script, 'w') as f:
                print("# GnuPlot script generated by rack/statistics.py", file=f)
                print(script, file=f)
