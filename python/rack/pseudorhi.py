...
def handle_gnuplot(args, progBuilder: rack.core.Rack): #, **kw_args): #range_m:tuple=None, height_m:tuple=None):
    ...
    #confCmdReg = rack.gnuplot.Registry(plotScript)
    plotScriptBuilder = rack.gnuplot.Registry(plotScript)
    # plotScriptBuilder = plotScriptBuilder
    ...
    plotScriptBuilder.plot(filename=f"{args.basename}-background.png", filetype="png",     
