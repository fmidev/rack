...
#WRITE_DOC "Add radar grid and background map"
RUN_TEST \\  --inputPrefix '$PWD/' \\  --gTitle "'\${what:date|%Y-%m-%d} \${what:time|%H:%M UTC}  \${NOD} - \${PLC}'" \\  data-kiira/201708121600_radar.polar.fikor.h5 \\  --cProj 3067 --cSize 600 \\  -Q DBZH -c \\  --gLinkImage "'\${inputPrefix}/maps/map-radar:\${NOD}-\${where:EPSG}-\${where:xsize}x\${where:ysize}.png'" \\  --gAlign 'HORZ_FILL:VERT_FILL' \\  --imageTransp 0.0:0.1,0,1 --palette default \\  -o "'out-\${what:date}T\${what:time}-\${NOD}.png'" \\  --gRadarDot 5000 \\  --gDot 21.37:59.781667,12000:15000  \\  --gStyle ".DOT='stroke-width:3px;fill:red'" \\ --gStyle ".SPOT='stroke:none;fill:white'"  \\  -o place_marker 
...
#WRITE_DOC "Test grid clipping" 
#RUN_TEST \\ --inputPrefix '$PWD/' \\ $COMP_CONF \\  --script "'-Q DBZH --cRange 80000 --cAdd --gRadarGrid 10000:1,15,MASK=true --gRadarLabel \"\${what:date|%A, %d %B %Y}£\${NOD}|\${PLC}£\${what:time}\" '" \\ 'data-kiira/201708121600_radar.polar.fi{ika,kor,van}.h5' \\   --cExtract DATA \\  --gLinkImage '$PWD/data-kiira/map-kiira.png' \\  --gAlign 'HORZ_FILL:VERT_FILL'  -P --imageTransp "''" \\  -o composite3.png \\ --gStyle .LABEL="'fill:white;stroke:forestgreen;font-size:10px'" -o "composite-Labels2"
...
RUN_TEST \\  volume.h5 --cProj 3067 --cSize 400 -Q DBZH -c "$CONF" -o gray.png --palette "'default'" -o rgb.png \\  --outputPalette legend.svg \\  -o 'Example_with_a_legend'
...
WRITE_HELP 'gLayout'
WRITE_DOC 'Example:'
RUN_TEST  \\ --script "'--cReset --cProj 3067 --cSize 300 -Q DBZH -c --palette \"\" -o out-\${what:date}T\${what:time}-\${NOD}.png'"  \\  --gLayout 'VERT,DOWN,RIGHT'  --gGroupTitle "'Grouping by time: \${what:time|%H:%M} UTC'"    'data-kiira/201708121?00*.h5'   -o 'Time_series2' 
